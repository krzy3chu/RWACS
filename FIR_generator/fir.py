...
fir_h.add_line()
fir_h.end_if_def()
fir_h.write_to_file("../STM32_firmware/Components/Fir/fir.h")
print("Generated fir.h file")

#  Fir/fir.c source code file
fir_c = CodeWriter()
fir_c.add_autogen_comment("fir.py")
fir_c.add_line()
fir_c.include("fir.h")
fir_c.add_line()
fir_c.add_variable_initialization(FIR_b)
fir_c.write_to_file("../STM32_firmware/Components/Fir/fir.c")
print("Generated fir.c file")
